...
package data.fringe {
  ...
  object ExampleProductData {
    lazy val ExampleConstantSingleton: data.fringe.ConstantSingleton.type = Extractors.ConstantSingletonExtractor.extract(JObject(Nil))
